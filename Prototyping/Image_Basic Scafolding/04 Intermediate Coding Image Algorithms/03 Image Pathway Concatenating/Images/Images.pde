...
void setup() {
  ...
  appHeight = height;
  //
  /* Image Pathway Concatenation
   - Similar to Music Pathway Concatenation
   - JAVA can be coded to do this automatically
   */
  String up = "..";
  String open = "/";
  String imagesFolder = "Images";
  String squareFolder = "Square";
  String landscapeFolder = "Landscape";
  String portraitFolder = "Portrait";
  String imagesPath = up + open + up + open + up + open + up + open + up + open;
  String soccerBallImage = "SoccerBall"; //"../../../../Images/Square/SoccerBall.jpg"
  String bikeImage = "bike"; //"../../../../Images/Landscape/bike.jpg"
  ...
  picBackground = loadImage( imagesPath + imagesFolder + open + squareFolder + open + soccerBallImage + fileExtension );
  bikeX_Changed = bikeX = appWidth * 1/4;
  bikeY_Changed = bikeY = appHeight * 1/4;
  bikeWidth = appWidth * 1/2;
  bikeHeight = appHeight * 1/2;
  picBike = loadImage( imagesPath + imagesFolder + open + landscapeFolder + open + bikeImage + fileExtension );
